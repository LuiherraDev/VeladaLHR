const Projects = () => {
  return (
    <section className="px-8 py-12 mx-auto text-center max-w-5xl" id="proyectos">
      <h3 className="font-jost-semi text-txt-primary tracking-[0.3em] uppercase mb-2 text-lg">Proyectos</h3>
      ...
      <div className="bg-card-bg/50 border-white/10 rounded-2xl p-8 backdrop-blur-sm" data-purpose="project-card">
        ...
        <p className="leading-relaxed text-txt-primary text-lg font-jost-reg mx-auto mb-8 max-w-3xl">
